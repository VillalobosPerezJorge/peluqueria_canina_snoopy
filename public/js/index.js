document.addEventListener('DOMContentLoaded', async () => {
    ...
    const apiUrl = 'https://angelespeluditos.cl/api//api/banner/list';
            ...
            data.banners.banners.forEach((banner, index) => {
                ...
                if(index >= 0 && index < 5){
                    ...
                    let bannerString = index == 0 ? `<div class="carousel-item active">
                        <img src="https://angelespeluditos.cl/api//api/banner/showimage/${banner._id}" class="d-block w-100" alt="${banner.title}" id="carousel_${index + 1}">
...
const insertarPerroDelMes = async () => {
    ...
    try {
        const response = await fetch('https://angelespeluditos.cl/api//api/post/findSelected');
        ...
        perroDelMesDiv.innerHTML = `<img class="img-fluid w-100" src="https://angelespeluditos.cl/api//api/post/showImage/${postId}/2" alt="imagen del perro del mes" style="border-radius: 15px 50px; box-shadow: 0 8px 6px -6px rgba(0, 0, 0, 0.5)">`
