...
const cambiarRolUsuario = async (userId) => {
    ...
    try {
        const response = await fetch(`http://angelespeluditos.cl:3000/api/user/changeRole/${userId}`, {
            method: 'PATCH',
            headers: {
 ...
 const actualizarUsuario = async (userId) => {
    ...
    actualizarBtn.onclick = async () => {
        ...
        try {
            const response = await fetch(`http://angelespeluditos.cl:3000/api/user/update/${userId}`, {
                method: 'PATCH',
                headers: {
                    'Content-type': 'application/json; charset=utf-8',
                    'Authorization': token
...
const obtenerListaUsuarios = async () => {
    ...
    try {
        const response = await fetch(`http://angelespeluditos.cl:3000/api/user/listUsers/${windowPage}`, {
            method: 'GET',
            headers: {
                'Content-type': 'application/json; charset=utf-8',
                'Authorization': token
...
const eliminarUsuario = async (userId) => {
    ...
    try {
        const response = await fetch(`http://angelespeluditos.cl:3000/api/user/delete/${userId}`, {
            method: 'POST',
            headers: {
                'Content-type': 'application/json; charset=utf-8',
                'Authorization': token
